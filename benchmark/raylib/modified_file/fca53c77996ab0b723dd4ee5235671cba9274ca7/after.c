...
*       white character of default font [rtext], this way, raylib text and shapes can be draw witbool CheckCollisionCircles(Vector2 center1, float radius1, Vector2 h
